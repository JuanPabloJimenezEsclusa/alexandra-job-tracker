...
/**
 * Caching decorator over {@link LoadJobApplicationPort} and {@link SaveJobApplicationPort}.
 */
public class CachingJobApplicationAdapter implements LoadJobApplicationPort, SaveJobApplicationPort {
  ...
  /**
   * Retrieves a user's applications from cache or loads from the delegate.
   */
