...
class JobPostingEventProcessorTest {
  ...
  private JobPostingEventProcessor processor;

  @BeforeEach
  void setUp() {
    processor = new JobPostingEventProcessor(saveAppPort, analysisPort, saveAnalysisPort,
      FIXED_CLOCK, applicationCreatedCounter);
  }
